        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongDescription = table.Column<string>(maxLength: 200, nullable: true),
                    PhoneNumber = table.Column<bool>(nullable: false),
                    Price = table.Column<decimal>(nullable: false),
                    Rooms = table.Column<int>(nullable: false),
                    ShortDescription = table.Column<string>(maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_AspNetUsers_CustomerId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_CustomerId1",
                table: "Properties",
                column: "CustomerId1");
